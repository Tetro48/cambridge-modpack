...
local GameMode = require 'tetris.modes.config_framework'
...
Marathon2020Game.name = "Training Marathon 2020"
Marathon2020Game.hash = "Marathon2020Training"
...
function Marathon2020Game:onStart()
	self.level = self.starting_section * 100
	for key, value in pairs(self.torikan_passed) do
		if self.level >= key then
